...
public class GoalTest {
    ...
    public void testGetters() {
        Goal gol = new Goal("This is a goal", 1, true, 3, 0, "Home");
    ...
    public void testEquals(){
        Goal gol = new Goal("This is a goal", 1, true, 3, 0,"Home");
        Goal eql_gol = new Goal("This is a goal", 1, true, 3, 0, "Home");
        Goal bad_cont = new Goal("This is not a goal", 1, true, 3, 0, "Home");
        Goal bad_id = new Goal("This is a goal", 2, true, 3, 0, "Home");
        Goal bad_comp = new Goal("This is a goal", 1, false, 3, 0, "Home");
        Goal bad_sort = new Goal("This is a goal", 1, true, 4, 0, "Home");
