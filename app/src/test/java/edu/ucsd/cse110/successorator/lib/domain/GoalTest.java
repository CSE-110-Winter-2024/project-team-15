...
public class GoalTest {
    ...
    public void testGetters() {
        Goal gol = new Goal("This is a goal", 1, true, 3, 0, 0);
    ...
    public void testEquals(){
        Goal gol = new Goal("This is a goal", 1, true, 3, 0,0);
        Goal eql_gol = new Goal("This is a goal", 1, true, 3, 0, 0);
        Goal bad_cont = new Goal("This is not a goal", 1, true, 3, 0, 0);
        Goal bad_id = new Goal("This is a goal", 2, true, 3, 0, 0);
        Goal bad_comp = new Goal("This is a goal", 1, false, 3, 0, 0);
        Goal bad_sort = new Goal("This is a goal", 1, true, 4, 0, 0);
